...
static inline unsigned int bit_count(unsigned int v)
{
	unsigned int c;
...
struct loongson_pinctrl_group {
	...
	unsigned int *pins;          /* Contained pins software gpio num*/
...
struct loongson_pinctrl {
	...
	unsigned int num_chips;              /*num gpio chips*/
	unsigned int total_pins;             /*total pins of this pinctrl*/
