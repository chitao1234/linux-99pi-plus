...
static int es8323_probe(struct snd_soc_component *codec)
{
	...
	es8323->mclk = devm_clk_get_optional(codec->dev, "mclk");
	...
	data = snd_soc_component_read(codec, 0x09);
	data = snd_soc_component_read(codec, 0x12);
	data = snd_soc_component_read(codec, 0x13);
