...
extern int ls_pcm_trigger(struct snd_soc_component *component, struct snd_pcm_substream *substream, int cmd);
extern snd_pcm_uframes_t ls_pcm_pointer(struct snd_soc_component *component, struct snd_pcm_substream *substream);
extern int __ls_pcm_prepare(struct snd_soc_component *component, struct snd_pcm_substream *substream);
extern irqreturn_t ls_pcm_dma_irq(int irq, void *dev_id);
extern int __ls_pcm_open(struct snd_soc_component *component, struct snd_pcm_substream *substream);
extern int __ls_pcm_close(struct snd_soc_component *component, struct snd_pcm_substream *substream);
extern int ls_pcm_preallocate_dma_buffer(struct snd_pcm *pcm, int stream);
extern void ls_pcm_free_dma_buffers(struct snd_soc_component *component, struct snd_pcm *pcm);
